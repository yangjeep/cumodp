...
LcmPolyPair(sfixn *dgLcmAddr, sfixn d1, sfixn *f1, sfixn d2, sfixn *f2, MONTP_OPT2_AS_GENE * pPtr ){
  sfixn degR, *degRAddr=&degR, *RPtr, *Lcm, 
    *Prod, dgProd, *dgProdAddr=&dgProd, *Gcd, dGcd, *dGcdAddr=&dGcd;   
  ...
  //Lcm=SquareFreeFact(dgLcmAddr, dgProd, Prod, pPtr->P);  
 ...
 **/
sfixn *
SquareFreeFact(sfixn *degQAddr, sfixn degF, sfixn *FPtr, sfixn p){
